...
public final class AlchemyCore{
	...
	static{
		...
		REAGENTS[4] = new StaticReagent("fluid.tile.crossroads.water", 0D, 100D, 4, (EnumMatterPhase phase) -> phase == EnumMatterPhase.GAS ? TRANSLUCENT_WHITE_COLOR : TRANSLUCENT_BLUE_COLOR, (stack) -> stack.getItem() == Item.getItemFromBlock(Blocks.PACKED_ICE), () -> new ItemStack(Blocks.PACKED_ICE), 50, 0, null);
		...
		REAGENTS[20] = new StaticReagent("tile.bedrock.name", Short.MAX_VALUE - 1, Short.MAX_VALUE, 20, (EnumMatterPhase phase) -> Color.GRAY, (stack) -> stack.getItem() == Item.getItemFromBlock(Blocks.BEDROCK), () -> new ItemStack(Blocks.BEDROCK), 50, 0, null);
		...
		REAGENTS[26] = new StaticReagent("item.sulphur.name", Short.MAX_VALUE - 1, Short.MAX_VALUE, 26, (EnumMatterPhase phase) -> Color.GRAY, MiscOp.oreDictPred("gunpowder"), () -> MiscOp.getOredictStack("gunpowder", 1), 10, 0, null);
		...
		REAGENTS[29] = new StaticReagent("item.diamond.name", 2000D, 3000D, 29, (EnumMatterPhase phase) -> Color.CYAN, MiscOp.oreDictPred("gemDiamond"), () -> MiscOp.getOredictStack("gemDiamond", 1), 10, 0, null);
		REAGENTS[30] = new StaticReagent("item.quartz.name", 2000D, 3000D, 30, (EnumMatterPhase phase) -> Color.WHITE, (stack) -> stack.getItem() == Items.QUARTZ, () -> new ItemStack(Items.QUARTZ), 10, 0, null);
